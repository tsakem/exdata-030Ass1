##Generation of Graph showing household global minute-averaged active power (in kilowatt) per minute
...
##Plot of the graph and save the plot as a png file
png(file = "plot2.png", width = 480, height = 480)
plot(selecteddata$Time,as.numeric(selecteddata$Global_active_power), type="n", ylab="Global Active Power (kilowatts)", xlab="")
